    ...
    + Ord
{
    ...
    ///
    /// **Only called from `SparsePolynomial::s_poly`**, which is itself a
    /// post-hoc GB validation helper (see the comment there). Not part of
    /// the GB pipeline; ark-gb computes its own LCMs internally.
