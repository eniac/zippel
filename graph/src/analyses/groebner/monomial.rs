    ...
    + Ord
{
    ...
    ///
    /// Backed by the external `ark-gb` crate: `GrevLexTerm` and `ElimTerm`
    /// both override this through `ark_gb_adapter`. ~10000× faster than
    /// the in-tree Buchberger on Katsura/Cyclic-n.
