...
fn main() {
    println!("=== Virtual Test (ArkBls12_381) ===");
    let args = ZippelArgs::new(PathBuf::from("examples/virtual_test/virtual_test.zippel"));
    ...
    let analysis_result = std::panic::catch_unwind(|| {
        let analysis_args =
            ZippelArgs::new(PathBuf::from("examples/virtual_test/virtual_test.zippel"));
...
fn prover_create_inputs() -> Ctx<Vid, Value<ArkBls12_381>> {
    ...
    Ctx::<Vid, Value<ArkBls12_381>>::from_iter([(Vid("x".to_string()), Value::Scalar(x))])
}
