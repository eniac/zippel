...
fn main() {
    println!("=== Type Alias & Typed Let Bindings (ArkBls12_381) ===");
    let args = ZippelArgs::new(PathBuf::from("examples/tests/type_alias/type_alias.zippel"));
    ...
    let analysis_result = std::panic::catch_unwind(|| {
        let analysis_args =
            ZippelArgs::new(PathBuf::from("examples/tests/type_alias/type_alias.zippel"));
