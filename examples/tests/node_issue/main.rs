...
fn main() {
    ...
    let args = ZippelArgs::new(PathBuf::from("examples/tests/node_issue/node_issue.zippel"));
    ...
    let analysis_result = std::panic::catch_unwind(|| {
        let analysis_args =
            ZippelArgs::new(PathBuf::from("examples/tests/node_issue/node_issue.zippel"));
