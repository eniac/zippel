...
fn main() {
    ...
    let args = ZippelArgs::new(PathBuf::from("examples/schnorr_quadratic/schnorr.zippel"));
    ...
    println!("\n--- Static Analysis ---");
    let analysis_args = ZippelArgs::new(PathBuf::from("examples/schnorr_quadratic/schnorr.zippel"));
    ...
    match &soundness_result {
        ...
        Err(e) => println!("K-Soundness (l=3):    ✗ {}", e),
    }
